...
class AxisAlignedBoundingBox(Geometry3D):
    color: npt.NDArray[Annotated[np.float64, "3,1"]]
    max_bound: npt.NDArray[Annotated[np.float64, "3,1"]]
    min_bound: npt.NDArray[Annotated[np.float64, "3,1"]]
    @overload
...
class HalfEdge:
    ...
    triangle_index: int
    twin: int
    vertex_indices: npt.NDArray[Annotated[np.int32, "2,1"]]
    @overload
    def __init__(self) -> None: ...
    @overload
...
class HalfEdgeTriangleMesh(MeshBase):
    ...
    ordered_half_edge_from_vertex: List[open3d.utility.IntVector]
    triangle_normals: open3d.utility.Vector3dVector
...
class KDTreeFlann:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, data: npt.NDArray[Annotated[np.float64, "m,n"]]) -> None: ...
    @overload
...
class MeshBase(Geometry3D):
    ...
    vertex_normals: open3d.utility.Vector3dVector
...
class OctreeNodeInfo:
    ...
    origin: npt.NDArray[Annotated[np.float64, "3,1"]]
    size: float
    def __init__(self, origin, size, depth, child_index) -> None: ...
...
class OrientedBoundingBox(Geometry3D):
    R: npt.NDArray[Annotated[np.float64, "3,3"]]
    center: npt.NDArray[Annotated[np.float64, "3,1"]]
    color: npt.NDArray[Annotated[np.float64, "3,1"]]
    extent: npt.NDArray[Annotated[np.float64, "3,1"]]
    @overload
    def __init__(self) -> None: ...
    @overload
...
class PointCloud(Geometry3D):
    colors: open3d.utility.Vector3dVector
    covariances: open3d.utility.Matrix3dVector
    normals: open3d.utility.Vector3dVector
    points: open3d.utility.Vector3dVector
    @overload
    def __init__(self) -> None: ...
    @overload
    ...
    def estimate_normals(
        self, search_param=..., fast_normal_computation=...
    ) -> Any: ...
    ...
    def remove_statistical_outlier(
        self, nb_neighbors, std_ratio, print_progress=...
    ) -> Any: ...
    def segment_plane(
        self, distance_threshold, ransac_n, num_iterations, probability=...
    ) -> Any: ...
    ...
    def voxel_down_sample_and_trace(
        self, voxel_size, min_bound, max_bound, approximate_class=...
    ) -> Any: ...
...
class TriangleMesh(MeshBase):
    ...
    triangle_material_ids: open3d.utility.IntVector
    triangle_normals: open3d.utility.Vector3dVector
    triangle_uvs: open3d.utility.Vector2dVector
    triangles: open3d.utility.Vector3iVector
    vertex_colors: open3d.utility.Vector3dVector
    vertex_normals: open3d.utility.Vector3dVector
    vertices: open3d.utility.Vector3dVector
    ...
    def filter_sharpen(
        self, number_of_iterations=..., strength=..., filter_scope=...
    ) -> Any: ...
    def filter_smooth_laplacian(
        self, number_of_iterations=..., lambda_filter=..., filter_scope=...
    ) -> Any: ...
    def filter_smooth_simple(
        self, number_of_iterations=..., filter_scope=...
    ) -> Any: ...
    def filter_smooth_taubin(
        self, number_of_iterations=..., lambda_filter=..., mu=..., filter_scope=...
    ) -> Any: ...
    ...
    def sample_points_poisson_disk(
        self, number_of_points, init_factor=..., pcl=..., use_triangle_normal=...
    ) -> Any: ...
    def sample_points_uniformly(
        self, number_of_points=..., use_triangle_normal=...
    ) -> Any: ...
    def select_by_index(self, indices, cleanup=...) -> Any: ...
    def simplify_quadric_decimation(
        self, target_number_of_triangles, maximum_error=..., boundary_weight=...
    ) -> Any: ...
...
class Voxel:
    color: npt.NDArray[Annotated[np.float64, "3,1"]]
    grid_index: npt.NDArray[Annotated[np.int32, "3,1"]]
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: Voxel) -> None: ...
    @overload
    def __init__(self, grid_index: npt.NDArray[Annotated[np.int32, "3,1"]]) -> None: ...
    @overload
    def __init__(
        self,
        grid_index: npt.NDArray[Annotated[np.int32, "3,1"]],
...
class VoxelGrid(Geometry3D):
    ...
    def carve_depth_map(
        self, depth_map, camera_params, keep_voxels_outside_image=...
    ) -> Any: ...
    def carve_silhouette(
        self, silhouette_mask, camera_params, keep_voxels_outside_image=...
    ) -> Any: ...
...
def get_rotation_matrix_from_axis_angle(
    rotation: npt.NDArray[Annotated[np.float64, "3,1"]]
) -> npt.NDArray[Annotated[np.float64, "3,3"]]: ...
def get_rotation_matrix_from_quaternion(
    rotation: npt.NDArray[Annotated[np.float64, "4,1"]]
) -> npt.NDArray[Annotated[np.float64, "3,3"]]: ...
